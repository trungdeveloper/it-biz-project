        ...
        <Router>
            <div>
                ...
                <Switch>
                    ...
                    <Route
                        path="/profile/donationInformationProfile"
                        component={DonationInformationProfilePage}
                    />
                    <Route
                        path="/profile/receiveDonationProfile"
                        component={ReceiveDonationProfilePage}
                    />
                    <Route
